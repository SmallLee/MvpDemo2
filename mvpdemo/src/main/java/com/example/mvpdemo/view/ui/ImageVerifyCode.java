 ...
 */
public class ImageVerifyCode extends View {
    ...
    public ImageVerifyCode(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initAttrValues(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ImageVerifyCode);
        //获取TypeArray的长度
        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (index) {
                case R.styleable.ImageVerifyCode_codeTextSize:
                    ...
                    break;
                case R.styleable.ImageVerifyCode_codeBackground:
                    mCodeBackground = typedArray.getColor(index, Color.WHITE);
                    break;
                case R.styleable.ImageVerifyCode_codeLength:
                    mCodeLength = typedArray.getInteger(index, 4);
                    break;
                case R.styleable.ImageVerifyCode_isContainChar:
                    isContainChar = typedArray.getBoolean(index, false);
                    break;
                case R.styleable.ImageVerifyCode_pointNum:
                    mPointNum = typedArray.getInteger(index, 100);
                    break;
                case R.styleable.ImageVerifyCode_linNum:
